...
require (
	...
	github.com/filecoin-project/curio v1.24.5
...
require (
	...
	github.com/ipni/go-libipni v0.6.13 // indirect
...
replace github.com/filecoin-project/filecoin-ffi => github.com/strahe/filecoin-ffi-panic v1.30.0
