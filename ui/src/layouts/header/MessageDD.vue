...
<template>
  ...
  <!-- notifications DD -->
  <!-- ---------------------------------------------- -->
  <v-menu v-model="MessageMenu" :close-on-content-click="false" offset="6, 0">
    ...
    <v-sheet class="notification-dropdown" rounded="md" width="395">
      <div class="pa-4">
      ...
      <perfect-scrollbar style="height: calc(100vh - 300px); max-height: 267px">
        <v-list aria-busy="true" aria-label="message list" class="py-0" lines="two">
          <v-list-item class="py-3" color="secondary" value="1">
            <template #prepend>
              <v-avatar class="py-2" size="40">
                <img alt="user vector" src="@/assets/images/users/avatar-2.png" width="40">
              </v-avatar>
            </template>
          ...
          <v-divider />
          <v-list-item class="py-3" color="secondary" value="2">
            <template #prepend>
              <v-avatar class="py-2" size="40">
                <img alt="user vector" src="@/assets/images/users/avatar-3.png" width="40">
              </v-avatar>
            </template>
            <div class="d-inline-flex justify-space-between w-100">
          ...
          <v-divider />
          <v-list-item class="py-3" color="secondary" value="3">
            <template #prepend>
              <v-avatar class="py-2" size="40">
                <img alt="user vector" src="@/assets/images/users/avatar-4.png" width="40">
              </v-avatar>
            </template>
            <div class="d-inline-flex justify-space-between w-100">
              <h6 class="text-subtitle-1 font-weight-regular mb-0">
          ...
          <v-divider />
          <v-list-item class="py-3" color="secondary" value="4">
            <template #prepend>
              <v-avatar class="py-2" size="40">
                <img alt="user vector" src="@/assets/images/users/avatar-5.png" width="40">
              </v-avatar>
            </template>
            <div class="d-inline-flex justify-space-between w-100">
              <h6 class="text-subtitle-1 font-weight-regular mb-0">
